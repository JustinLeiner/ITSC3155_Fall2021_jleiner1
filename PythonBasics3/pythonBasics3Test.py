...
#Test case for starts_with_non_number
    def test_starts_with_non_number(self):
        ...
        self.assertEqual(pythonBasics3.starts_with_non_number("how are you today?"), True)

        self.assertEqual(pythonBasics3.starts_with_non_number("3..2..1.. Blast off!"), False)

        self.assertEqual(pythonBasics3.starts_with_non_number("2 hours run time"), False)
...
#Test case for multiple_words
    def test_multiple_words(self):
        ...
        self.assertEqual(pythonBasics3.multiple_words(" I like food "), True)

        self.assertEqual(pythonBasics3.multiple_words("Do-not"), False)

        self.assertEqual(pythonBasics3.multiple_words("Today is a sunny day"), True)
